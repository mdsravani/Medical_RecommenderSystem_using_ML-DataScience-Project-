...
#load datasets
symt_des=pd.read_csv("datasets/symtoms_df.csv")
...
def predict():
    if request.method=='POST':
        ...
        return render_template('index.html',predicted_disease=predicted_disease,dis_des=descr,dis_pre=my_pre,dis_med=my_med,dis_wkout=wkout,dis_die=die)
